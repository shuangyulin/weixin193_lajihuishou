  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='huishouyuan'"  label="商家编号" prop="shangjiabianhao">
          <el-input v-model="ruleForm.shangjiabianhao" readonly              placeholder="商家编号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='huishouyuan'"  label="商家名称" prop="shangjiamingcheng">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='huishouyuan'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='huishouyuan'"  label="商家地址" prop="shangjiadizhi">
          <el-input v-model="ruleForm.shangjiadizhi"               placeholder="商家地址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='huishouyuan'"  label="经营范围" prop="jingyingfanwei">
          <el-input v-model="ruleForm.jingyingfanwei"               placeholder="经营范围" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='huishouyuan'" label="商家图片" prop="shangjiatupian">
          <file-upload
          tip="点击上传商家图片"
          action="file/upload"
          :limit="3"
          ...
          @change="huishouyuanshangjiatupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    huishouyuanshangjiatupianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.shangjiabianhao)&& 'huishouyuan'==this.flag){
      ...
      if((!this.ruleForm.shangjiamingcheng)&& 'huishouyuan'==this.flag){
        this.$message.error('商家名称不能为空');
        return
      }
      if( 'huishouyuan' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
