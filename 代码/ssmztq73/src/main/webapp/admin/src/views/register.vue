<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">微信小程序的社区垃圾回收管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="商家编号" class="input" v-if="tableName=='huishouyuan'">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='huishouyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="商家名称" class="input" v-if="tableName=='huishouyuan'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='huishouyuan'">
			...
			<el-form-item label="商家地址" class="input" v-if="tableName=='huishouyuan'">
			...
			<el-form-item label="经营范围" class="input" v-if="tableName=='huishouyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `huishouyuan` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
